// src// src/screens/transporter/OperationsScreen.tsx
      ...
      const OperationsScreen = () => {
        ...
        const handleCitySelect = (city: string) => {
          if (cityPickerField === 'from') {
            setNewRoute({...newRoute, from: city});
          } else {
            setNewRoute({...newRoute, to: city});
          }
        };
        ...
        // Render Route Modal with City Pickers
      ...
      // Additional styles for city picker
      // Stylesheet - Sab kuch ek hi jagah
